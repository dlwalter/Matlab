...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/BasicQuadrotorControl_interface
...
PRODUCT_NAME              = BasicQuadrotorControl_interface
MAKEFILE                  = BasicQuadrotorControl_interface.mk
COMPUTER                  = PCWIN64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Projects/Quadcopter/BasicQuadrotor
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = BasicQuadrotorControl_interface_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/BasicQuadrotorControl_interface
...
DEFINES_ = -D__AXI4STREAM_WRITE__ -DMODEL=BasicQuadrotorControl_interface -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DON_TARGET_WAIT_FOR_START=1 -DONESTEPFCN=1 -DEXT_MODE=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DARM_PROJECT -DRT -DSTACK_SIZE=64
...
DEFINES_STANDARD = -DMODEL=BasicQuadrotorControl_interface -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = C:/MATLAB/SupportPackages/R2014b/xilinxzynq7000ec/toolbox/target/supportpackages/zynq/@slCustomizer/../src/axi4Lite.c axi4Stream.c $(START_DIR)/BasicQuadrotorControl_interface_ert_rtw/BasicQuadrotorControl_interface.c $(START_DIR)/BasicQuadrotorControl_interface_ert_rtw/BasicQuadrotorControl_interface_data.c $(START_DIR)/BasicQuadrotorControl_interface_ert_rtw/rtGetInf.c $(START_DIR)/BasicQuadrotorControl_interface_ert_rtw/rtGetNaN.c $(START_DIR)/BasicQuadrotorControl_interface_ert_rtw/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/rtw/c/src/rtiostream/rtiostreamtcpip/rtiostream_tcpip.c C:/MATLAB/SupportPackages/R2014b/armcortexa/toolbox/target/supportpackages/arm_cortex_a/src/linuxinitialize.c

MAIN_SRC = $(START_DIR)/BasicQuadrotorControl_interface_ert_rtw/ert_main.c
...
OBJS = axi4Lite.c.o axi4Stream.c.o ert_main.c.o BasicQuadrotorControl_interface.c.o BasicQuadrotorControl_interface_data.c.o rtGetInf.c.o rtGetNaN.c.o rt_nonfinite.c.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o linuxinitialize.c.o
...
%.c.o : $(START_DIR)/BasicQuadrotorControl_interface_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/BasicQuadrotorControl_interface_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/BasicQuadrotorControl_interface_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
