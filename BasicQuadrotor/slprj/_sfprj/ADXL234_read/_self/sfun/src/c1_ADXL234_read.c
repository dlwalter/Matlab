...
static void initialize_c1_ADXL234_read(SFc1_ADXL234_readInstanceStruct
  *chartInstance);
static void initialize_params_c1_ADXL234_read(SFc1_ADXL234_readInstanceStruct
  *chartInstance);
static void enable_c1_ADXL234_read(SFc1_ADXL234_readInstanceStruct
  *chartInstance);
static void disable_c1_ADXL234_read(SFc1_ADXL234_readInstanceStruct
  *chartInstance);
static void c1_update_debugger_state_c1_ADXL234_read
  (SFc1_ADXL234_readInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_ADXL234_read
  (SFc1_ADXL234_readInstanceStruct *chartInstance);
static void set_sim_state_c1_ADXL234_read(SFc1_ADXL234_readInstanceStruct
  *chartInstance, const mxArray *c1_st);
static void finalize_c1_ADXL234_read(SFc1_ADXL234_readInstanceStruct
  *chartInstance);
static void sf_gateway_c1_ADXL234_read(SFc1_ADXL234_readInstanceStruct
  *chartInstance);
static void mdl_start_c1_ADXL234_read(SFc1_ADXL234_readInstanceStruct
  *chartInstance);
static void c1_chartstep_c1_ADXL234_read(SFc1_ADXL234_readInstanceStruct
  *chartInstance);
static void initSimStructsc1_ADXL234_read(SFc1_ADXL234_readInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static uint64_T c1_emlrt_marshallIn(SFc1_ADXL234_readInstanceStruct
  *chartInstance, const mxArray *c1_b_XYZ_int, const char_T *c1_identifier);
static uint64_T c1_b_emlrt_marshallIn(SFc1_ADXL234_readInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static uint64_T c1_c_emlrt_marshallIn(SFc1_ADXL234_readInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
...
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_d_emlrt_marshallIn(SFc1_ADXL234_readInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_e_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static uint8_T c1_e_emlrt_marshallIn(SFc1_ADXL234_readInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
...
static const mxArray *c1_f_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_f_emlrt_marshallIn(SFc1_ADXL234_readInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_g_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static uint64_T c1_g_emlrt_marshallIn(SFc1_ADXL234_readInstanceStruct
  *chartInstance, const mxArray *c1_b_XYZ, const char_T *c1_identifier);
static uint64_T c1_h_emlrt_marshallIn(SFc1_ADXL234_readInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_i_emlrt_marshallIn(SFc1_ADXL234_readInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_ADXL234_read, const char_T
  *c1_identifier);
static uint8_T c1_j_emlrt_marshallIn(SFc1_ADXL234_readInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_ADXL234_readInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc1_ADXL234_readInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_ADXL234_read = 0U;
  ...
  (SFc1_ADXL234_readInstanceStruct *chartInstance)
{
  ...
  c1_c_hoistedGlobal = chartInstance->c1_is_active_c1_ADXL234_read;
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  *chartInstance->c1_XYZ = c1_g_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c1_is_active_c1_ADXL234_read = c1_i_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 2)),
     "is_active_c1_ADXL234_read");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_ADXL234_read(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_ADXL234_read(chartInstance);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_b_y = NULL;
  SFc1_ADXL234_readInstanceStruct *chartInstance;
  chartInstance = (SFc1_ADXL234_readInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_ADXL234_read_get_eml_resolved_functions_info(void)
{
  ...
  *c1_identifier)
{
  ...
  c1_y = c1_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_ADXL234_read), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_ADXL234_read);
  return c1_y;
}
...
void sf_c1_ADXL234_read_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c1_ADXL234_read_get_post_codegen_info(void);
mxArray *sf_c1_ADXL234_read_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c1_ADXL234_read_get_post_codegen_info();
...
mxArray *sf_c1_ADXL234_read_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_ADXL234_read_jit_fallback_info(void)
{
...
mxArray *sf_c1_ADXL234_read_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c1_ADXL234_read(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"XYZ\",},{M[4],M[0],T\"XYZ_int\",S'l','i','p'{{M1x2[62 69],M[0],}}},{M[8],M[0],T\"is_active_c1_ADXL234_read\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_ADXL234_read_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc1_ADXL234_readInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c1_ADXL234_read(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_ADXL234_readInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_ADXL234_read((SFc1_ADXL234_readInstanceStruct*)
    chartInstanceVar);
  initialize_c1_ADXL234_read((SFc1_ADXL234_readInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_ADXL234_read(void *chartInstanceVar)
{
  enable_c1_ADXL234_read((SFc1_ADXL234_readInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_ADXL234_read(void *chartInstanceVar)
{
  disable_c1_ADXL234_read((SFc1_ADXL234_readInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_ADXL234_read(void *chartInstanceVar)
{
  sf_gateway_c1_ADXL234_read((SFc1_ADXL234_readInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c1_ADXL234_read(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c1_ADXL234_read((SFc1_ADXL234_readInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c1_ADXL234_read(SimStruct* S, const mxArray *
  st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c1_ADXL234_read((SFc1_ADXL234_readInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c1_ADXL234_read(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_ADXL234_readInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c1_ADXL234_read((SFc1_ADXL234_readInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_ADXL234_read((SFc1_ADXL234_readInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_ADXL234_read(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_ADXL234_read(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c1_ADXL234_read(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_ADXL234_read(SimStruct *S)
{
  SFc1_ADXL234_readInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_ADXL234_readInstanceStruct *)utMalloc(sizeof
    (SFc1_ADXL234_readInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_ADXL234_readInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_ADXL234_read;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_ADXL234_read;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_ADXL234_read;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_ADXL234_read;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_ADXL234_read;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c1_ADXL234_read;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c1_ADXL234_read;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_ADXL234_read;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_ADXL234_read;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_ADXL234_read;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_ADXL234_read;
...
void c1_ADXL234_read_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_ADXL234_read(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_ADXL234_read(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_ADXL234_read(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_ADXL234_read_method_dispatcher.\n"
