...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_BasicQuadrotorControl_process_check_sum_call( int nlhs,
  ...
  extern unsigned int sf_hdlmdlgenlib_process_check_sum_call( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_BasicQuadrotorControl_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
...
unsigned int sf_process_machine_uses_exported_functions_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern void sf_BasicQuadrotorControl_uses_exported_functions( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "BasicQuadrotorControl") == 0) {
    sf_BasicQuadrotorControl_uses_exported_functions(nlhs, plhs, nrhs-2, prhs+2);
    return 1;
  }
...
{
  extern unsigned int sf_BasicQuadrotorControl_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "BasicQuadrotorControl") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_BasicQuadrotorControl_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_third_party_uses_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_BasicQuadrotorControl_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "BasicQuadrotorControl") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_BasicQuadrotorControl_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_jit_fallback_info_call( int nlhs, mxArray * plhs[],
  int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_BasicQuadrotorControl_jit_fallback_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "BasicQuadrotorControl") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_BasicQuadrotorControl_jit_fallback_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_updateBuildInfo_args_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_BasicQuadrotorControl_updateBuildInfo_args_info( int
  ...
  if (strcmp(machineName, "BasicQuadrotorControl") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_BasicQuadrotorControl_updateBuildInfo_args_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_BasicQuadrotorControl_get_eml_resolved_functions_info
  ...
  if (strcmp(machineName, "BasicQuadrotorControl") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_BasicQuadrotorControl_get_eml_resolved_functions_info(nlhs,plhs,2,
      newRhs);
  }
...
unsigned int sf_process_get_post_codegen_info(int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[])
{
  extern void sf_BasicQuadrotorControl_get_post_codegen_info( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  ...
  machineName[(sizeof(machineName)/sizeof(char)-1)] = '\0';
  if (strcmp(machineName, "BasicQuadrotorControl") == 0) {
    sf_BasicQuadrotorControl_get_post_codegen_info(nlhs, plhs, nrhs-2, prhs+2);
    return 1;
  }
...
extern unsigned int sf_BasicQuadrotorControl_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"BasicQuadrotorControl")) {
    return(sf_BasicQuadrotorControl_method_dispatcher(simstructPtr,
...
extern void BasicQuadrotorControl_terminator(void);
...
void sf_machine_global_terminator(void)
{
  ...
  if (sfGlobalMdlStartCallCounts == 0) {
    BasicQuadrotorControl_terminator();
    hdlsllib_terminator();
...
extern void BasicQuadrotorControl_initializer(void);
extern void hdlsllib_initializer(void);
extern void hdlmdlgenlib_initializer(void);
extern void BasicQuadrotorControl_register_exported_symbols(SimStruct* S);
extern void hdlsllib_register_exported_symbols(SimStruct* S);
extern void hdlmdlgenlib_register_exported_symbols(SimStruct* S);
extern void BasicQuadrotorControl_debug_initialize(struct SfDebugInstanceStruct*);
...
{
  BasicQuadrotorControl_register_exported_symbols(S);
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      BasicQuadrotorControl_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    BasicQuadrotorControl_initializer();
    if (!simModeIsRTWGen) {
