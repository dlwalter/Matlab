...
ARCHITECTURE rtl OF basicquadrotorcontrol_hdl_dut_pcore IS
  ...
  SIGNAL const_zero                       : unsigned(4 DOWNTO 0);  -- ufix5
...
BEGIN
  ...
  const_zero <= to_unsigned(2#00000#, 5);

  const_zero_1 <= '0';

  PmodJB1_tmp <= const_zero & unsigned'(PWM_motor2_1_sig & const_zero_1 & PWM_motor1_1_sig);
