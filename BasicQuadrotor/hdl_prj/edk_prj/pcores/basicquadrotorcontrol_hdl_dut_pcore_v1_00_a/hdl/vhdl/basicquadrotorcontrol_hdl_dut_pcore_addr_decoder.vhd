...
BEGIN
  ...
  decode_sel_en_motor1 <= '1' WHEN addr_sel_unsigned = to_unsigned(2#00000001000110#, 14) ELSE
      '0';
  ...
  decode_sel_duty_motor1 <= '1' WHEN addr_sel_unsigned = to_unsigned(2#00000001000111#, 14) ELSE
      '0';
  ...
  decode_sel_en_motor2 <= '1' WHEN addr_sel_unsigned = to_unsigned(2#00000001001000#, 14) ELSE
      '0';
  ...
  decode_sel_duty_motor2 <= '1' WHEN addr_sel_unsigned = to_unsigned(2#00000001001001#, 14) ELSE
      '0';
