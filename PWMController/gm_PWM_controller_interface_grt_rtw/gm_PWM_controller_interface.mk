...
## Generated on : Wed Oct 15 17:44:03 2014
## MATLAB Coder version: 2.6 (R2014a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\gm_PWM_controller_interface.exe
...
MODELREF_LINK_RSPFILE     = gm_PWM_controller_interface_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\gm_PWM_controller_interface.exe
...
INCLUDES_BUILDINFO = C:\MATLAB\SupportPackages\R2014a\zynq\include;$(MATLAB_ROOT)\toolbox\idelink\extensions\eclipseide\inc;$(START_DIR)\gm_PWM_controller_interface_grt_rtw;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\src\rtiostream\rtiostreamtcpip;$(MATLAB_ROOT)\toolbox\coder\rtiostream\src\utils
...
DEFINES_STANDARD = -DMODEL=gm_PWM_controller_interface -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = axi4Lite.c $(START_DIR)\gm_PWM_controller_interface_grt_rtw\gm_PWM_controller_interface.c $(START_DIR)\gm_PWM_controller_interface_grt_rtw\gm_PWM_controller_interface_data.c $(START_DIR)\gm_PWM_controller_interface_grt_rtw\rtGetInf.c $(START_DIR)\gm_PWM_controller_interface_grt_rtw\rtGetNaN.c $(START_DIR)\gm_PWM_controller_interface_grt_rtw\rt_nonfinite.c rt_logging.c $(MATLAB_ROOT)\rtw\c\src\ext_mode\common\rtiostream_interface.c $(MATLAB_ROOT)\rtw\c\src\rtiostream\rtiostreamtcpip\rtiostream_tcpip.c $(MATLAB_ROOT)\rtw\c\src\ext_mode\common\ext_svr.c $(MATLAB_ROOT)\rtw\c\src\ext_mode\common\updown.c $(MATLAB_ROOT)\rtw\c\src\ext_mode\common\ext_work.c $(MATLAB_ROOT)\toolbox\coder\rtiostream\src\utils\rtiostream_utils.c
...
OBJS = axi4Lite.obj gm_PWM_controller_interface.obj gm_PWM_controller_interface_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_logging.obj rtiostream_interface.obj rtiostream_tcpip.obj ext_svr.obj updown.obj ext_work.obj rtiostream_utils.obj
...
{$(START_DIR)\gm_PWM_controller_interface_grt_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\gm_PWM_controller_interface_grt_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{C:\MATLAB\SupportPackages\R2014a\zynq\src}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{C:\MATLAB\SupportPackages\R2014a\zynq\src}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
