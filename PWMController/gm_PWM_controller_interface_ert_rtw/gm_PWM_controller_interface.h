/*
 * File: gm_PWM_controller_interface.h
 *
...
typedef struct {
  ...
  zynq_AXIWrite_gm_PWM_controll_T obj_c;/* '<S4>/AXI4Lite_Write_duty' */
  zynq_AXIWrite_gm_PWM_controll_T obj_p;/* '<S4>/AXI4Lite_Write_direction' */
  boolean_T objisempty;                /* '<S4>/AXI4Lite_Write_enable' */
  boolean_T objisempty_c;              /* '<S4>/AXI4Lite_Write_duty' */
  boolean_T objisempty_b;              /* '<S4>/AXI4Lite_Write_direction' */
...
struct P_gm_PWM_controller_interface_T_ {
...
extern P_gm_PWM_controller_interface_T gm_PWM_controller_interface_P;
