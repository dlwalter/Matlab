...
MODEL                  = PWM_controller
MODULES                = PWM_controller_capi.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_nonfinite.c rtw_modelmap_utils.c 
MAKEFILE               = PWM_controller.mk
...
MODELLIB                  = PWM_controllerlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = PWM_controller_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\slprj\raccel\PWM_controller
