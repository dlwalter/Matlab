...
static boolean_T c3_c_emlrt_marshallIn(SFc3_untitledInstanceStruct
  ...
  *c3_identifier);
static boolean_T c3_d_emlrt_marshallIn(SFc3_untitledInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_e_emlrt_marshallIn(SFc3_untitledInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
...
static uint8_T c3_f_emlrt_marshallIn(SFc3_untitledInstanceStruct *chartInstance,
  const mxArray *c3_b_tp_I1, const char_T *c3_identifier);
static uint8_T c3_g_emlrt_marshallIn(SFc3_untitledInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_h_emlrt_marshallIn(SFc3_untitledInstanceStruct
  ...
  *chartInstance)
{
  ...
  if (chartInstance->c3_is_c3_untitled == c3_IN_I1) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c3_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c3_sfEvent);
  }

  if (chartInstance->c3_is_c3_untitled == c3_IN_I2) {
  ...
  *chartInstance)
{
  ...
  real_T *c3_count;
  c3_count = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c3_st = NULL;
  c3_st = NULL;
  c3_y = NULL;
  sf_mex_assign(&c3_y, sf_mex_createcellmatrix(4, 1), false);
  c3_hoistedGlobal = *c3_count;
  ...
  const mxArray *c3_st)
{
  ...
  *c3_count = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u,
    0)), "count");
  chartInstance->c3_reset_val = c3_c_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c3_u, 1)), "reset_val");
  chartInstance->c3_is_active_c3_untitled = c3_f_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c3_u, 2)), "is_active_c3_untitled");
  chartInstance->c3_is_c3_untitled = c3_f_emlrt_marshallIn(chartInstance,
...
static void sf_gateway_c3_untitled(SFc3_untitledInstanceStruct *chartInstance)
{
  ...
  real_T *c3_count;
  boolean_T *c3_reset;
  c3_reset = (boolean_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c3_count = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c3_B = (boolean_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c3_A = (boolean_T *)ssGetInputPortSignal(chartInstance->S, 0);
  c3_set_sim_state_side_effects_c3_untitled(chartInstance);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 0U, chartInstance->c3_sfEvent);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_A, 0U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_B, 1U);
  _SFD_DATA_RANGE_CHECK(*c3_count, 2U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_reset, 3U);
...
static void c3_chartstep_c3_untitled(SFc3_untitledInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c3_is_active_c3_untitled == 0U) {
    ...
    *c3_count = 0.0;
    ...
    _SFD_DATA_RANGE_CHECK(*c3_count, 2U);
    chartInstance->c3_reset_val = *c3_reset;
    c3_updateDataWrittenToVector(chartInstance, 1U);
    _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c3_reset_val, 4U);
    _SFD_SYMBOL_SCOPE_POP();
    chartInstance->c3_is_c3_untitled = c3_IN_I1;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c3_sfEvent);
    chartInstance->c3_tp_I1 = 1U;
  } else {
    switch (chartInstance->c3_is_c3_untitled) {
     case c3_IN_I1:
      ...
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_out, 2U, c3_b_sf_marshallOut,
        c3_b_sf_marshallIn);
      c3_out = CV_EML_IF(1, 0, 0, (real_T)*c3_A == 1.0);
      _SFD_SYMBOL_SCOPE_POP();
      guard2 = false;
      if (c3_out) {
        ...
        _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_b_out, 2U, c3_b_sf_marshallOut,
          c3_b_sf_marshallIn);
        c3_b_out = CV_EML_IF(3, 0, 0, (int32_T)*c3_A == (int32_T)*c3_B);
        _SFD_SYMBOL_SCOPE_POP();
        if (c3_b_out) {
          ...
          _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_d_nargout, 1U,
            c3_sf_marshallOut, c3_sf_marshallIn);
          c3_errorIfDataNotWrittenToFcn(chartInstance, 0U, 2U);
          (*c3_count)++;
          c3_updateDataWrittenToVector(chartInstance, 0U);
          _SFD_DATA_RANGE_CHECK(*c3_count, 2U);
          _SFD_SYMBOL_SCOPE_POP();
          chartInstance->c3_tp_I1 = 0U;
          _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c3_sfEvent);
          chartInstance->c3_is_c3_untitled = c3_IN_I2;
          _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c3_sfEvent);
          chartInstance->c3_tp_I2 = 1U;
        } else {
          ...
          c3_c_out = CV_EML_IF(4, 0, 0, (int32_T)*c3_A != (int32_T)*c3_B);
          _SFD_SYMBOL_SCOPE_POP();
          if (c3_c_out) {
      ...
      if (guard2 == true) {
        ...
        c3_d_out = CV_EML_IF(7, 0, 0, (int32_T)*c3_reset != (int32_T)
                             chartInstance->c3_reset_val);
        _SFD_SYMBOL_SCOPE_POP();
        if (c3_d_out) {
     ...
     case c3_IN_I2:
      ...
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_e_out, 2U, c3_b_sf_marshallOut,
        c3_b_sf_marshallIn);
      c3_e_out = CV_EML_IF(2, 0, 0, (real_T)*c3_A == 0.0);
      _SFD_SYMBOL_SCOPE_POP();
      guard1 = false;
      if (c3_e_out) {
        ...
        _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_f_out, 2U, c3_b_sf_marshallOut,
          c3_b_sf_marshallIn);
        c3_f_out = CV_EML_IF(5, 0, 0, (int32_T)*c3_A == (int32_T)*c3_B);
        _SFD_SYMBOL_SCOPE_POP();
        if (c3_f_out) {
          ...
          _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_g_out, 2U,
            c3_b_sf_marshallOut, c3_b_sf_marshallIn);
          c3_g_out = CV_EML_IF(6, 0, 0, (int32_T)*c3_A != (int32_T)*c3_B);
          _SFD_SYMBOL_SCOPE_POP();
          if (c3_g_out) {
      ...
      if (guard1 == true) {
        ...
        _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_h_out, 2U, c3_b_sf_marshallOut,
          c3_b_sf_marshallIn);
        c3_errorIfDataNotWrittenToFcn(chartInstance, 1U, 4U);
        c3_h_out = CV_EML_IF(8, 0, 0, (int32_T)*c3_reset != (int32_T)
                             chartInstance->c3_reset_val);
        _SFD_SYMBOL_SCOPE_POP();
        if (c3_h_out) {
  ...
  const mxArray *c3_b_tp_I1, const char_T *c3_identifier)
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_y = c3_g_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_b_tp_I1), &c3_thisId);
  sf_mex_destroy(&c3_b_tp_I1);
  return c3_y;
}
...
static void c3_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  const mxArray *c3_b_tp_I1;
  const char_T *c3_identifier;
  emlrtMsgIdentifier c3_thisId;
  uint8_T c3_y;
  SFc3_untitledInstanceStruct *chartInstance;
  chartInstance = (SFc3_untitledInstanceStruct *)chartInstanceVoid;
  c3_b_tp_I1 = sf_mex_dup(c3_mxArrayInData);
  c3_identifier = c3_varName;
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_y = c3_g_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_b_tp_I1), &c3_thisId);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3147980875U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3608353368U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1013885793U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3641073578U);
}
...
mxArray *sf_c3_untitled_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("zggEBpSisyDCc1zYu8YvTB");
...
static const mxArray *sf_get_sim_state_info_c3_untitled(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[6],T\"count\",},{M[3],M[32],T\"reset_val\",},{M[8],M[0],T\"is_active_c3_untitled\",},{M[9],M[0],T\"is_c3_untitled\",}}"
  };
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(2U, c3_count);
          _SFD_SET_DATA_VALUE_PTR(3U, c3_reset);
...
static void mdlSetWorkWidths_c3_untitled(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2400157982U));
  ssSetChecksum1(S,(4108369903U));
  ssSetChecksum2(S,(4188054089U));
  ssSetChecksum3(S,(3473307975U));
