...
#define _SFD_DATA_READ_BEFORE_WRITE_CHECK(dNum,dVal)\
                      sf_debug_read_before_write_check(sfGlobalDebugInstanceStruct, _PWM_controllerMachineNumber_,\
CHARTINSTANCE_CHARTNUMBER,\
CHARTINSTANCE_INSTANCENUMBER,\
...
#define CV_RELATIONAL_EVAL(v1,v2,v3,v4,v5,v6,v7)  cv_eval_relational(sfGlobalDebugInstanceStruct,_PWM_controllerMachineNumber_,\
		  CHARTINSTANCE_CHARTNUMBER,\
		  CHARTINSTANCE_INSTANCENUMBER,\
