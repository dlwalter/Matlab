...
%s
*constraints2r
^Time (s): cpu = 00:00:00 ; elapsed = 00:00:00.089 . Memory (MB): peak = 888.086 ; gain = 0.0002default:default
ƒ

Phase %s%s
101*constraints2
...
V
JPhase 1.1.2 Build Super Logic Region (SLR) Database | Checksum: 18e01e591
*common
‰

%s
*constraints2r
^Time (s): cpu = 00:00:00 ; elapsed = 00:00:00.109 . Memory (MB): peak = 888.086 ; gain = 0.0002default:default
k

Phase %s%s
101*constraints2
...
>
2Phase 1.1.3 Add Constraints | Checksum: 18e01e591
*common
‰

%s
*constraints2r
^Time (s): cpu = 00:00:00 ; elapsed = 00:00:00.110 . Memory (MB): peak = 888.086 ; gain = 0.0002default:default
h

Phase %s%s
101*constraints2
...
%s
*constraints2r
^Time (s): cpu = 00:00:01 ; elapsed = 00:00:00.349 . Memory (MB): peak = 888.086 ; gain = 0.0002default:default
|

Phase %s%s
101*constraints2
...
O
CPhase 1.1.5 Implementation Feasibility check | Checksum: 2297df0a5
*common
‰

%s
*constraints2r
^Time (s): cpu = 00:00:01 ; elapsed = 00:00:00.470 . Memory (MB): peak = 888.086 ; gain = 0.0002default:default
k

Phase %s%s
101*constraints2
...
>
2Phase 1.1.6 Pre-Place Cells | Checksum: 2297df0a5
*common
‰

%s
*constraints2r
^Time (s): cpu = 00:00:01 ; elapsed = 00:00:00.476 . Memory (MB): peak = 888.086 ; gain = 0.0002default:default
Ž

Phase %s%s
101*constraints2
...
a
UPhase 1.1.7 IO Placement/ Clock Placement/ Build Placer Device | Checksum: 1bb142501
*common
…

%s
*constraints2n
ZTime (s): cpu = 00:00:01 ; elapsed = 00:00:01 . Memory (MB): peak = 888.086 ; gain = 0.0002default:default
v

Phase %s%s
101*constraints2
...
C
7Phase 1.1.8.1.1 Build Clock Data | Checksum: 23524fff9
*common
…

%s
*constraints2n
ZTime (s): cpu = 00:00:02 ; elapsed = 00:00:02 . Memory (MB): peak = 889.586 ; gain = 1.5002default:default
B
6Phase 1.1.8.1 Place Init Design | Checksum: 25d3290d2
*common
…

%s
*constraints2n
ZTime (s): cpu = 00:00:03 ; elapsed = 00:00:02 . Memory (MB): peak = 889.613 ; gain = 1.5272default:default
I
...
Q
EPhase 1.1.9.1 Constrain Global/Regional Clocks | Checksum: 24e86eff0
*common
…

%s
...
ZTime (s): cpu = 00:00:03 ; elapsed = 00:00:02 . Memory (MB): peak = 889.613 ; gain = 1.5272default:default
@
4Phase 1 Placer Initialization | Checksum: 24e86eff0
*common
…

%s
...
%s
*constraints2n
ZTime (s): cpu = 00:00:07 ; elapsed = 00:00:06 . Memory (MB): peak = 896.816 ; gain = 8.7302default:default
h

Phase %s%s
101*constraints2
...
%s
*constraints2o
[Time (s): cpu = 00:00:08 ; elapsed = 00:00:06 . Memory (MB): peak = 904.063 ; gain = 15.9772default:default
p

Phase %s%s
101*constraints2
...
C
7Phase 3.3 Area Swap Optimization | Checksum: 172036151
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:08 ; elapsed = 00:00:07 . Memory (MB): peak = 904.063 ; gain = 15.9772default:default
o

Phase %s%s
101*constraints2
...
B
6Phase 3.4 Timing Path Optimizer | Checksum: 22dcbe1ca
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:09 ; elapsed = 00:00:07 . Memory (MB): peak = 904.836 ; gain = 16.7502default:default
z

Phase %s%s
101*constraints2
...
M
APhase 3.5 Commit Small Macros & Core Logic | Checksum: 1d2fee6b2
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:09 ; elapsed = 00:00:07 . Memory (MB): peak = 908.848 ; gain = 20.7622default:default
l

Phase %s%s
101*constraints2
...
?
3Phase 3.6 Re-assign LUT pins | Checksum: 1d2fee6b2
*common
†

%s
...
@
4Phase 4.1 PCOPT Shape updates | Checksum: 1e2ce18d9
*common
†

%s
...
Q
EPhase 4.2.1 Post Placement Timing Optimization | Checksum: 1fe6690c3
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:10 ; elapsed = 00:00:08 . Memory (MB): peak = 908.848 ; gain = 20.7622default:default
H
...
C
7Phase 4.3 Post Placement Cleanup | Checksum: 1fe6690c3
*common
†

%s
...
C
7Phase 4.4.1 Congestion Reporting | Checksum: 1fe6690c3
*common
†

%s
...
A
5Phase 4.4.2 updateTiming final | Checksum: 1c5e1396e
*common
†

%s
...
C
7Phase 4.4.3 Dump Critical Paths  | Checksum: 1c5e1396e
*common
†

%s
...
>
2Phase 4.4.5 Print Final WNS | Checksum: 1c5e1396e
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:11 ; elapsed = 00:00:08 . Memory (MB): peak = 908.848 ; gain = 20.7622default:default
=
1Phase 4.4 Placer Reporting | Checksum: 1c5e1396e
*common
†

%s
...
D
8Phase 4.5 Final Placement Cleanup | Checksum: 1ce3858b9
*common
†

%s
...
[Time (s): cpu = 00:00:11 ; elapsed = 00:00:08 . Memory (MB): peak = 908.848 ; gain = 20.7622default:default
S
GPhase 4 Post Placement Optimization and Clean-Up | Checksum: 1ce3858b9
*common
†

%s
...
%s
*constraints2o
[Time (s): cpu = 00:00:00 ; elapsed = 00:00:08 . Memory (MB): peak = 908.848 ; gain = 20.7622default:default
Q
Releasing license: %s
83*common2"
...
908.8482default:default2
22.6602default:defaultZ17-268
^
...

sreport_utilization: Time (s): cpu = 00:00:00 ; elapsed = 00:00:00.047 . Memory (MB): peak = 911.719 ; gain = 0.000
*common
j
