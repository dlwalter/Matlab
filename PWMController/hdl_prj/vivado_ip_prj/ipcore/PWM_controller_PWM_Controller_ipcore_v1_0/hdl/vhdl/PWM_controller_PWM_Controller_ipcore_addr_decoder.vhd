-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\PWM_controller\PWM_controller_PWM_Controller_ipcore_addr_decoder.vhd
...
-- Source Path: PWM_controller_PWM_Controller_ipcore/PWM_controller_PWM_Controller_ipcore_axi_lite/PWM_controller_PWM_Controller_ipcore_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY PWM_controller_PWM_Controller_ipcore_addr_decoder IS
...
END PWM_controller_PWM_Controller_ipcore_addr_decoder;


ARCHITECTURE rtl OF PWM_controller_PWM_Controller_ipcore_addr_decoder IS
...
BEGIN
  ...
  decode_sel_enable <= '1' WHEN addr_sel_unsigned = to_unsigned(2#00000001000000#, 14) ELSE
      '0';
  ...
  decode_sel_duty <= '1' WHEN addr_sel_unsigned = to_unsigned(2#00000001000001#, 14) ELSE
      '0';
  ...
  decode_sel_direction <= '1' WHEN addr_sel_unsigned = to_unsigned(2#00000001000010#, 14) ELSE
      '0';
