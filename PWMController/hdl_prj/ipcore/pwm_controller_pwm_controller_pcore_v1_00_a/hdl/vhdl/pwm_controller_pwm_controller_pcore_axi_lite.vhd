-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\PWM_controller\pwm_controller_pwm_controller_pcore_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: pwm_controller_pwm_controller_pcore_axi_lite
-- Source Path: pwm_controller_pwm_controller_pcore/pwm_controller_pwm_controller_pcore_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY pwm_controller_pwm_controller_pcore_axi_lite IS
...
END pwm_controller_pwm_controller_pcore_axi_lite;


ARCHITECTURE rtl OF pwm_controller_pwm_controller_pcore_axi_lite IS

  -- Component Declarations
  COMPONENT pwm_controller_pwm_controller_pcore_addr_decoder
  ...
  COMPONENT pwm_controller_pwm_controller_pcore_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI_Lite_ARESETN                :   IN    std_logic;  -- ufix1
          AXI_Lite_AWADDR                 :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
          AXI_Lite_AWVALID                :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : pwm_controller_pwm_controller_pcore_addr_decoder
    USE ENTITY work.pwm_controller_pwm_controller_pcore_addr_decoder(rtl);

  FOR ALL : pwm_controller_pwm_controller_pcore_axi_lite_module
    USE ENTITY work.pwm_controller_pwm_controller_pcore_axi_lite_module(rtl);
  ...
  SIGNAL inst_enable                      : std_logic;  -- ufix1
  SIGNAL inst_duty                        : std_logic_vector(7 DOWNTO 0);  -- ufix8
  SIGNAL inst_direction                   : std_logic;  -- ufix1
...
BEGIN
  u_pwm_controller_pwm_controller_pcore_addr_decoder_inst : pwm_controller_pwm_controller_pcore_addr_decoder
    PORT MAP( clk => AXI_Lite_ACLK,  -- ufix1
              ...
              write_enable => inst_enable,  -- ufix1
              write_duty => inst_duty,  -- ufix8
              write_direction => inst_direction  -- ufix1
              );

  u_pwm_controller_pwm_controller_pcore_axi_lite_module_inst : pwm_controller_pwm_controller_pcore_axi_lite_module
    PORT MAP( clk => AXI_Lite_ACLK,  -- ufix1
  ...
  write_enable <= inst_enable;

  write_duty <= inst_duty;

  write_direction <= inst_direction;
