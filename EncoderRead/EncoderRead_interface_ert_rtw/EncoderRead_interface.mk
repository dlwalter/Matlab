###########################################################################
## Makefile generated for Simulink model 'EncoderRead_interface'. 
## 
## Makefile     : EncoderRead_interface.mk
## Generated on : Wed Feb 11 18:09:29 2015
## MATLAB Coder version: 2.7 (R2014b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/EncoderRead_interface
...
PRODUCT_NAME              = EncoderRead_interface
MAKEFILE                  = EncoderRead_interface.mk
COMPUTER                  = PCWIN64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Projects/Quadcopter/EncoderRead
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = EncoderRead_interface_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/EncoderRead_interface
...
INCLUDES_BUILDINFO = -IC:/MATLAB/SupportPackages/R2014b/xilinxzynq7000ec/toolbox/target/supportpackages/zynq/include -I$(START_DIR)/EncoderRead_interface_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -IC:/MATLAB/SupportPackages/R2014b/xilinxzynq7000ec/toolbox/target/supportpackages/zynq/@slCustomizer/../include -IC:/MATLAB/SupportPackages/R2014b/armcortexa/toolbox/target/supportpackages/arm_cortex_a/include
...
DEFINES_ = -D__AXI4STREAM_WRITE__ -DMODEL=EncoderRead_interface -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DON_TARGET_WAIT_FOR_START=1 -DONESTEPFCN=1 -DEXT_MODE=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DARM_PROJECT -DRT -DSTACK_SIZE=64
...
DEFINES_STANDARD = -DMODEL=EncoderRead_interface -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = C:/MATLAB/SupportPackages/R2014b/xilinxzynq7000ec/toolbox/target/supportpackages/zynq/@slCustomizer/../src/axi4Lite.c axi4Stream.c $(START_DIR)/EncoderRead_interface_ert_rtw/EncoderRead_interface.c $(START_DIR)/EncoderRead_interface_ert_rtw/EncoderRead_interface_data.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/rtw/c/src/rtiostream/rtiostreamtcpip/rtiostream_tcpip.c C:/MATLAB/SupportPackages/R2014b/armcortexa/toolbox/target/supportpackages/arm_cortex_a/src/linuxinitialize.c

MAIN_SRC = $(START_DIR)/EncoderRead_interface_ert_rtw/ert_main.c
...
OBJS = axi4Lite.c.o axi4Stream.c.o ert_main.c.o EncoderRead_interface.c.o EncoderRead_interface_data.c.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o linuxinitialize.c.o
...
%.c.o : $(START_DIR)/EncoderRead_interface_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/EncoderRead_interface_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/EncoderRead_interface_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
