-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\ZedBoardTest\zedboardtest_led_counter_pcore.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: zedboardtest_led_counter_pcore
-- Source Path: zedboardtest_led_counter_pcore
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY zedboardtest_led_counter_pcore IS
...
END zedboardtest_led_counter_pcore;


ARCHITECTURE rtl OF zedboardtest_led_counter_pcore IS

  -- Component Declarations
  COMPONENT zedboardtest_led_counter_pcore_axi_lite
  ...
  COMPONENT zedboardtest_led_counter_pcore_dut
  ...
  FOR ALL : zedboardtest_led_counter_pcore_axi_lite
    USE ENTITY work.zedboardtest_led_counter_pcore_axi_lite(rtl);

  FOR ALL : zedboardtest_led_counter_pcore_dut
    USE ENTITY work.zedboardtest_led_counter_pcore_dut(rtl);
...
BEGIN
  u_zedboardtest_led_counter_pcore_axi_lite_inst : zedboardtest_led_counter_pcore_axi_lite
    PORT MAP( reset => reset,
              ...
              read_read_back1 => read_back1_sig,  -- ufix1
              read_read_back2 => read_back2_sig,  -- ufix1
              read_read_back3 => read_back3_sig,  -- ufix1
              read_read_back4 => read_back4_sig,  -- ufix1
              ...
              write_in1 => in1_sig,  -- ufix1
              write_in2 => in2_sig,  -- ufix1
              reset_internal => reset_internal  -- ufix1
              );

  u_zedboardtest_led_counter_pcore_dut_inst : zedboardtest_led_counter_pcore_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              dut_enable => dut_enable,  -- ufix1
              in1 => in1_sig,  -- ufix1
              in2 => in2_sig,  -- ufix1
              in3 => PmodJA1_slice,  -- ufix1
              in4 => PmodJA1_slice_1,  -- ufix1
  ...
  GPLEDs_tmp <= const_zero & unsigned'(LED4_sig & LED3_sig & LED2_sig & LED1_sig);
