-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\ZedBoardTest\zedboardtest_subsystem_pcore_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: zedboardtest_subsystem_pcore_axi_lite
-- Source Path: zedboardtest_subsystem_pcore/zedboardtest_subsystem_pcore_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY zedboardtest_subsystem_pcore_axi_lite IS
...
END zedboardtest_subsystem_pcore_axi_lite;


ARCHITECTURE rtl OF zedboardtest_subsystem_pcore_axi_lite IS

  -- Component Declarations
  COMPONENT zedboardtest_subsystem_pcore_addr_decoder
  ...
  COMPONENT zedboardtest_subsystem_pcore_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : zedboardtest_subsystem_pcore_addr_decoder
    USE ENTITY work.zedboardtest_subsystem_pcore_addr_decoder(rtl);

  FOR ALL : zedboardtest_subsystem_pcore_axi_lite_module
    USE ENTITY work.zedboardtest_subsystem_pcore_axi_lite_module(rtl);
...
BEGIN
  u_zedboardtest_subsystem_pcore_addr_decoder_inst : zedboardtest_subsystem_pcore_addr_decoder
  ...
  u_zedboardtest_subsystem_pcore_axi_lite_module_inst : zedboardtest_subsystem_pcore_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
