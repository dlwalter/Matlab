...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_PmodACL_IP_14a_process_check_sum_call( int nlhs,
  ...
  extern unsigned int sf_hdlmdlgenlib_process_check_sum_call( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_PmodACL_IP_14a_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
...
unsigned int sf_process_machine_uses_exported_functions_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern void sf_PmodACL_IP_14a_uses_exported_functions( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "PmodACL_IP_14a") == 0) {
    sf_PmodACL_IP_14a_uses_exported_functions(nlhs, plhs, nrhs-2, prhs+2);
    return 1;
  }
...
{
  extern unsigned int sf_PmodACL_IP_14a_autoinheritance_info( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "PmodACL_IP_14a") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_PmodACL_IP_14a_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_third_party_uses_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_PmodACL_IP_14a_third_party_uses_info( int nlhs, mxArray
    * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "PmodACL_IP_14a") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_PmodACL_IP_14a_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_jit_fallback_info_call( int nlhs, mxArray * plhs[],
  int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_PmodACL_IP_14a_jit_fallback_info( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "PmodACL_IP_14a") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_PmodACL_IP_14a_jit_fallback_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_updateBuildInfo_args_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_PmodACL_IP_14a_updateBuildInfo_args_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "PmodACL_IP_14a") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_PmodACL_IP_14a_updateBuildInfo_args_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_PmodACL_IP_14a_get_eml_resolved_functions_info( int
  ...
  if (strcmp(machineName, "PmodACL_IP_14a") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_PmodACL_IP_14a_get_eml_resolved_functions_info(nlhs,plhs,2,newRhs);
  }
...
unsigned int sf_process_get_post_codegen_info(int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[])
{
  extern void sf_PmodACL_IP_14a_get_post_codegen_info( int nlhs, mxArray * plhs[],
    int nrhs, const mxArray * prhs[] );
  ...
  machineName[(sizeof(machineName)/sizeof(char)-1)] = '\0';
  if (strcmp(machineName, "PmodACL_IP_14a") == 0) {
    sf_PmodACL_IP_14a_get_post_codegen_info(nlhs, plhs, nrhs-2, prhs+2);
    return 1;
  }
...
extern unsigned int sf_PmodACL_IP_14a_method_dispatcher(SimStruct *S, unsigned
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"PmodACL_IP_14a")) {
    return(sf_PmodACL_IP_14a_method_dispatcher(simstructPtr,chartFileNumber,
...
extern void PmodACL_IP_14a_terminator(void);
...
{
  PmodACL_IP_14a_register_exported_symbols(S);
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      PmodACL_IP_14a_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    PmodACL_IP_14a_initializer();
    if (!simModeIsRTWGen) {
