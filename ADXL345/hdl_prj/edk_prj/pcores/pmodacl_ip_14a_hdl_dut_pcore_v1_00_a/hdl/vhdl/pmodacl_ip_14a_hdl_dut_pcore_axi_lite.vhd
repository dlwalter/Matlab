-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\PmodACL_IP_14a\pmodacl_ip_14a_hdl_dut_pcore_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: pmodacl_ip_14a_hdl_dut_pcore_axi_lite
-- Source Path: pmodacl_ip_14a_hdl_dut_pcore/pmodacl_ip_14a_hdl_dut_pcore_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY pmodacl_ip_14a_hdl_dut_pcore_axi_lite IS
...
END pmodacl_ip_14a_hdl_dut_pcore_axi_lite;


ARCHITECTURE rtl OF pmodacl_ip_14a_hdl_dut_pcore_axi_lite IS

  -- Component Declarations
  COMPONENT pmodacl_ip_14a_hdl_dut_pcore_addr_decoder
  ...
  COMPONENT pmodacl_ip_14a_hdl_dut_pcore_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : pmodacl_ip_14a_hdl_dut_pcore_addr_decoder
    USE ENTITY work.pmodacl_ip_14a_hdl_dut_pcore_addr_decoder(rtl);

  FOR ALL : pmodacl_ip_14a_hdl_dut_pcore_axi_lite_module
    USE ENTITY work.pmodacl_ip_14a_hdl_dut_pcore_axi_lite_module(rtl);
...
BEGIN
  u_pmodacl_ip_14a_hdl_dut_pcore_addr_decoder_inst : pmodacl_ip_14a_hdl_dut_pcore_addr_decoder
  ...
  u_pmodacl_ip_14a_hdl_dut_pcore_axi_lite_module_inst : pmodacl_ip_14a_hdl_dut_pcore_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
